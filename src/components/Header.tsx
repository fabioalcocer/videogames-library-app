    ...
    <header className="flex w-full max-w-7xl items-center justify-between px-6 py-5 text-zinc-100">
      ...
      <div className="relative">
        <input
          type="search"
          name="search"
          className="peer rounded-full bg-zinc-700/60 py-2 pl-11 pr-0 sm:text-sm sm:pr-6 text-xs font-medium text-zinc-900 transition-all duration-300 placeholder:text-neutral-400 hover:bg-zinc-100 focus:bg-zinc-100 focus:outline-none focus:border-transparent focus:ring-0"
