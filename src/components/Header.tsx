  ...
  return (
    <header className="flex w-full items-center justify-between px-6 py-5 text-zinc-100 md:justify-start md:px-10 md:py-8">
      <Link href="/" onClick={() => setTitle("New and trending")}>
        <h1 className="text-lg font-extrabold tracking-[6px] mr-5 lg:mr-8">VLFA</h1>
      </Link>
      <SearchBar />
      <nav className="hidden ml-8 min-w-max lg:block">
      ...
      <GrMenu className="text-2xl invert lg:hidden" />
    </header>
  );
}
