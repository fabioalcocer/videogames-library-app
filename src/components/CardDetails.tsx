...
function CardDetails({ game, setShow }: Props) {
  return (
    <div className="z-10 flex animate-fade flex-col bg-[#202020] lg:absolute lg:-bottom-[135px] lg:left-0 lg:right-0 lg:hidden lg:p-4 lg:pt-0 lg:group-hover:block rounded-b-md">
